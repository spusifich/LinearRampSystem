...
\text{If } \abs{\sum_{i=1}^{2^m}S_i}<\sum_{i=1}^{2^m}\abs{S_i},\text{ then }\sgn(\tau)=0;\text{ otherwise }\sgn(\tau)=S_1.
\end{equation}
\end{document}
